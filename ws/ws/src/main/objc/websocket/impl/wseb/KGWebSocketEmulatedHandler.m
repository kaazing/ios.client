...
-initWithWebSocketEmulatedHandler:(KGWebSocketEmulatedHandler *)webSocketEmulatedHandler;
...
-(KGCreateHandler *) createCreateHandler {
    ...
    id<KGCreateHandlerListener> _createHandlerListener = [[KGCreateHandlerListener_1 alloc] initWithWebSocketEmulatedHandler:self];
...
-(KGDownstreamHandler *) createDownstreamHandler {
    ...
    id<KGDownstreamHandlerListener> _downstreamHandlerListener = [[KGDownstreamHandlerListener_1 alloc] initWithWebSocketEmulatedHandler:self];
